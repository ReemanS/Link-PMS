...
<html lang="en">
  ...
  <body>
    <main class="d-flex flex-nowrap">
      <aside
        class="col-2 border p-2 h-100 min-vh-100 d-flex flex-column fixed-top"
      >
        ...
        <ul id="nav-contents" class="nav nav-pills flex-column mb-auto">
          <li class="nav-item">
            <a
              href="dashboardpage.php"
              class="nav-link py-3 d-flex rounded-4 active"
            >
          ...
          <li class="nav-item">
            <a
              href="inquirypage.php"
              class="inactive-hover-items nav-link py-3 rounded-4 d-flex"
            >
          ...
          <li class="nav-item">
            <a
              href="transactionspage.php"
              class="inactive-hover-items nav-link py-3 d-flex rounded-4"
            >
        ...
        <div id="site-user" class="d-flex align-items-center">
          <img
            src="../assets/zuc.jpg"
            alt="link officer"
            class="img-thumbnail rounded-5 me-2"
            width="60"
            height="60"
          />
      ...
      <section class="col-10 p-2 bg-hero mw-100">
        <div class="mx-5 my-1">
          <h1
            class="text-bg-primary fw-bold bg-opacity-50 p-2 rounded animate__animated animate__fadeIn"
            style="width: 34%"
          >
            Hello there, Mark!
          </h1>
          ...
          <div class="d-flex">
            ...
            <div class="bg-light p-3 d-flex flex-column rounded-4 col-9 me-2">
              ...
              <div class="d-flex flex-row align-items-center">
                ...
                <button
                  class="btn btn-outline-primary btn-sm me-1 rounded-pill"
                >
                  All
                </button>
                <button class="btn btn-info btn-sm me-1 rounded-pill">
                  In progress
                </button>
                <button class="btn btn-success btn-sm me-1 rounded-pill">
                  Completed
                </button>
              </div>
              <!-- Projects Cards -->
              <div class="mt-3 row row-cols-3 g-0">
                ...
                <div class="col">
                  <article class="card m-1 rounded-5">
                    <div
                      class="card-header bg-primary rounded-top-5 d-flex align-items-center"
                    >
                      <a
                        class="col-10 fs-5 text-white fw-bold text-decoration-none"
                        href="#"
                      >
                        University Hinampang 2023
                      </a>
                      <div class="col-2 text-center">
                        <div class="dropend">
                          <button
                            class="btn text-primary text-white dropdown-toggle"
            ...
            <div class="bg-light p-3 d-flex flex-column rounded-4 col-3">
              ...
              <div
                class="bg-white rounded-pill d-flex justify-content-between p-1 border"
              >
                <span
                  class="material-symbols-outlined bg-primary rounded-pill text-white"
                >
                  chevron_left
                </span>
                <div>May, 2023</div>
              ...
              <div
                class="bg-white rounded-4 d-flex justify-content-between p-1 border"
              >
                <span
                ...
                <div class="d-flex justify-content-evenly">
                  ...
                  <div
                    class="d-block text-center mx-2 bg-primary text-white px-2 rounded-2"
                  >
                    <span>Sun</span>
                    <h5>02</h5>
                  </div>
              ...
              <div class="mt-3">
                <div class="input-group">
                  ...
                  />
                  <button
                    class="btn btn-sm btn-outline-primary rounded-end-4"
                    type="button"
                  >
              ...
              <div
                class="bg-primary bg-gradient text-white p-2 rounded-3 mb-2"
                style="height: 90px"
              >
