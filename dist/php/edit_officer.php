    ...
    <section class="col-10 p-2 bg-secondary-subtle">
      ...
      <div class="d-flex flex-nowrap">
        <section class="col-4 container p-2 bg-white border rounded">
          ...
          $sql = "SELECT OFF_ID, OFF_GivenName, OFF_Surname FROM officer";
            ...
            <div class="list-group overflow-y-auto" style="max-height: 60vh">
              ...
              if ($resultCheck > 0) {
                while ($row = mysqli_fetch_assoc($result)) {
                  $OFF_ID = $row['OFF_ID']; ?>
                  <a href="edit_officerCode.php?newofficerid=<?php echo $OFF_ID ?>&inquiryid=<?php echo $INQ_ID ?>" class="list-group-item list-group-item-action d-flex justify-content-between align-items-center">
