                    ...
                    <form method="post">
                        <div class="mb-3">
                            ...
                            <input type="text" name="MEM_GivenName" id=" " class="form-control"
                                value="<?php echo $MEM_GIVENNAME ?>" />
                        </div>
                        <div class="mb-3">
                            <label for="" class="form-label">Surname</label>
                            <input type="text" name="MEM_Surname" id=" " class="form-control"
                                value="<?php echo $MEM_SURNAME ?>" />
                        </div>
                        <div class="mb-3">
                            <label for="" class="form-label">Email Address</label>
                            <input type="email" name="MEM_EmailAdd" id=" " class="form-control"
                                value="<?php echo $MEM_EMAILADD ?>" />
                        </div>
                        <div class="mb-3">
                            <label for="" class="form-label">Date of Birth</label>
                            <input type="date" name="MEM_DOB" id=" " class="form-control"
                                value="<?php echo $MEM_DOB ?>" />
                        </div>
